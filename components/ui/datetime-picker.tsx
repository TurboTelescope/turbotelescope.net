/**
 * Shadcn Datetime Picker with support for timezone, date and time selection,
 * minimum and maximum date limits, and 12-hour format... Check out the live
 * demo at https://shadcn-datetime-picker-pro.vercel.app/ Find the latest source
...
export type DateTimePickerProps = {
     ...
     * screen readers. If you want to use the datetime picker inside a dialog,
    ...
    max?: Date;
    /**
     * The timezone to display the datetime in, based on the date-fns. For a
     * complete list of valid time zone identifiers, refer to:
    ...
    classNames?: {
        /**
         * Custom class names for the trigger (the button that opens the
         * picker).
         */
        trigger?: string;
    };
...
function buildTime(options: BuildTimeOptions) {
    const { ampm, formatStr, hour, minute, second, use12HourFormat, value } = options;
    let date: Date;
    if (use12HourFormat) {
