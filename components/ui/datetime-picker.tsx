...
/**
 * Time is stored in the 24-hour form, but needs to be displayed to the user in
 * its 12-hour representation
 */
...
const TimePickerInput = React.forwardRef<HTMLInputElement, TimePickerInputProps>(
    (
        ...
        /**
         * Allow the user to enter the second digit within 2 seconds otherwise
         * start again with entering first digit
         */
        React.useEffect(() => {
            if (flag) {
...
type DateTimePickerProps = {
    ...
    placeholder?: string;
    /**
     * The year range will be: `This year + yearRange` and `this year -
     * yearRange`. Default is 50. For example: This year is 2024, The year
     * dropdown will be 1974 to 2024 which is generated by `2024 - 50 = 1974`
     * and `2024 + 50 = 2074`.
     */
    yearRange?: number;
    /**
     ...
     * shows all time inputs.
     */
    granularity?: Granularity;
    className?: string;
    /**
     * Show the default month and time when popup the calendar. Default is the
     * current Date().
     */
...
const DateTimePicker = React.forwardRef<Partial<DateTimePickerRef>, DateTimePickerProps>(
    (
        ...
        /**
         * Carry over the current time when a user clicks a new day instead of
         * resetting to 00:00
         */
