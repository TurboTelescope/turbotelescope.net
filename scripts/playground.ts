 ...
 * Run with:
 *
 *      POSTGRES_URL="postgres://turbo:TURBOTURBO@popcorn.spa.umn.edu:5432/turbo?sslmode=require" npx tsx ./scripts/playground.ts
 */
...
const program = Effect.gen(function* () {
    ...
    const pps = yield* db.getDataInRange(from, until);
});
